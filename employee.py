...
class employeeClass:
    def __init__(self,root):
        ...
        self.root.focus_force()    #to hightlight new window
        ...
        #=============Buttons=====================
        btn_save=Button(self.root,text="Save",command=self.add,font=("goudy old style",15),bg="#2196f3",fg="white",cursor="hand2").place(x=500,y=305,width=110,height=27)
        btn_update=Button(self.root,text="Update",command=self.update,font=("goudy old style",15),bg="#4caf50",fg="white",cursor="hand2").place(x=620,y=305,width=110,height=27)
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="#f44336",fg="white",cursor="hand2").place(x=740,y=305,width=110,height=27)
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),bg="#607d9b",fg="white",cursor="hand2").place(x=860,y=305,width=110,height=27)
        ...
        self.EmployeeTable["show"]="headings"    #Show Only Our Headings
    ...
    def update(self):
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                row=cur.fetchone()
                if row==None:
                    messagebox.showerror("Error", "Invalid Employee ID, try diffrent",parent=self.root)
